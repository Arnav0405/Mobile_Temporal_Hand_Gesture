...
class TemporalBlock(nn.Module):
    def __init__(self, n_inputs, n_outputs, kernel_size, stride, dilation, padding, dropout=0.2):
        ...
        self.net = nn.Sequential(
                    self.conv1, self.batchnorm1, self.chomp1, self.leakyRelu1, self.dropout1,
                    self.conv2, self.batchnorm2, self.chomp2, self.leakyRelu2, self.dropout2
                    )
...
class TCNModel(nn.Module):
    def __init__(self, input_size=63, output_size=4, num_channels=[32, 64], kernel_size=5, dropout=0.15):
